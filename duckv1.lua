...
if getgenv().Team == "Marines" then
    ReplicatedStorage.Remotes.CommF:InvokeServer("SetTeam", "Marines")
elseif getgenv().Team == "Pirates" then
    ReplicatedStorage.Remotes.CommF:InvokeServer("SetTeam", "Pirates")
end
...
FASTAT:OnChanged(function(value)
    if value then
        ...
        -- Set notification when Fast Attack is turned ON
        game.StarterGui:SetCore(
            "SendNotification",
            {
                Title = "Duck hub",
        ...
        -- Set notification when Fast Attack is turned OFF
        game.StarterGui:SetCore(
            "SendNotification",
            {
                Title = "Duck hub",
        ...
        -- Set the Fast Attack flag to false to stop attacking
        _G.FastAttack = false
    end
end)
